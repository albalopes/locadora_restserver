...
<div id="container">
    ...
    <div id="body">
        ...
        <h3>Atores (from database)</h3>        
        <ol>
            <li><a href="<?php echo site_url('api/locadora/ator'); ?>">Ator</a> - defaulting to JSON</li>
            <li><a href="<?php echo site_url('api/locadora/ator/format/csv'); ?>">Ator</a> - get it in CSV</li>
            <li><a href="<?php echo site_url('api/locadora/ator/id/1'); ?>">Ator #1</a> - defaulting to JSON  (ator/id/1)</li>
            <li><a href="<?php echo site_url('api/locadora/ator/1'); ?>">Ator #1</a> - defaulting to JSON  (ator/1)</li>
            <li><a href="<?php echo site_url('api/locadora/ator/id/1.xml'); ?>">Ator #1</a> - get it in XML (ator/id/1.xml)</li>
            <li><a href="<?php echo site_url('api/locadora/ator/id/1/format/xml'); ?>">Ator #1</a> - get it in XML (ator/id/1/format/xml)</li>
            <li><a href="<?php echo site_url('api/locadora/ator/id/1?format=xml'); ?>">Ator #1</a> - get it in XML (ator/id/1?format=xml)</li>
            <li><a href="<?php echo site_url('api/locadora/ator/1.xml'); ?>">Ator #1</a> - get it in XML (ator/1.xml)</li>
            <li><a id="ajax" href="<?php echo site_url('api/locadora/ator/format/json'); ?>">Ator</a> - get it in JSON (AJAX request)</li>
            <li><a href="<?php echo site_url('api/locadora/ator.html'); ?>">Ator</a> - get it in HTML (ator.html)</li>
            <li><a href="<?php echo site_url('api/locadora/ator/format/html'); ?>">Ator</a> - get it in HTML (ator/format/html)</li>
            <li><a href="<?php echo site_url('api/locadora/ator?format=html'); ?>">Ator</a> - get it in HTML (ator?format=html)</li>
        </ol>
